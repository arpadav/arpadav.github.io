...
function create_sidebar_html(params, json_arr) {
  let sidebar_html = '<li><a href=\"../../../gator/\" target=\"_parent\"><img style=\"width: 268px;\" src="../../../resources/images/alligator.png"/></a></li>'
  ...
  if (links) {
    ...
    for (let i = 0; i < parents.length; i++) {
      sidebar_html = sidebar_html + '<li><h3><b>' + parents[i]['name'] + '</b></h3></li>';
      ...
      for (let j = children.length - 1; j >= 0; j--) { // backwards, for rough chronological
        ...
        if (j > 0) sidebar_html = sidebar_html + '<li>§</li>';
      }
    }
  }
